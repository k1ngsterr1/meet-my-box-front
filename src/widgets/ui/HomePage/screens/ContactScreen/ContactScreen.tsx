    ...
    <>
      <section className={styles.contact} id="contacts-mob">
        ...
        <Paragraph margin="mt-4" width="w-3/4" isCentered={true}>
          ...
          <a href="http://t.me/meetmbox" className="text-main">
            Telegram
          </a>
          или
          <a href="https://wa.me/393931577805" className="text-main">
            WhatsApp
          </a>
          , либо заполнить форму и мы сами свяжемся с вами
        </Paragraph>
        <ContactForm />
        <ContactLink
      ...
      <section className={styles.contact_pc} id="contacts-pc">
        <div className={styles.contact_pc__left}>
          ...
          <Paragraph width="w-3/4">
            ...
            {""} или
            <a className="text-main" href="https://wa.me/393931577805">
              {""} WhatsApp
            </a>
            , либо заполнить форму и мы сами свяжемся с вами
          </Paragraph>
