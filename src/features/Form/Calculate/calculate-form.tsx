...
export const CalculateForm = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (fromCountry === "Italy" || fromCountry === "Germany") {
      ...
      if (weight > 15) {
        setError(
          "Дисклеймер: Вес, который вы указали (объемный или фактический) превышает 15 кг. Наш совет: разбейте посылку на две коробки поменьше или напишите нам для решения вопроса."
        );
        return;
      }
